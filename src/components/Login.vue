    ...
    <div class="col-md-4 forms">
      ...
      <form>
        <div class="form-icons">
          ...
          <button class="button expanded" v-on:click="login()" type="button">Login</button>
  ...
  methods: {
    login() {
        if(this.input.email != "" && this.input.password !=""){
            axios
                .post("http://192.168.43.199:8083/api/user/checkUser", {
    ...
    //     if (this.input.email == "chamod@gmail.com") {
    //       if (this.input.password == "kanishka") {
    //         this.successful = true;
    //         this.$router.replace({ name: "Events" });
    //       }
    //     } 

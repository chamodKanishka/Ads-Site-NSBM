            ...
            <div class="app-dashboard-body off-canvas-wrapper">
                <div id="app-dashboard-sidebar" class="app-dashboard-sidebar position-left off-canvas off-canvas-absolute reveal-for-medium" data-off-canvas>
                    ...
                    <div class="app-dashboard-sidebar-inner">
                        <ul class="menu vertical">
                            ...
                            <li><router-link to="/Admin/RegisterRequest"  class="active">
                ...
                <div class="app-dashboard-body-content off-canvas-content" data-off-canvas-content>
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Register Request</h1>
                        <div class="btn-toolbar mb-2 mb-md-0">
                            <div class="btn-group mr-2">
                                <button type="button" class="btn btn-sm btn-outline-secondary">New Request</button>
                                <button type="button" class="btn btn-sm btn-outline-secondary">Completed Request</button>
                            </div>
                        </div>
                    </div>
